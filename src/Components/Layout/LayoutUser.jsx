...
const LayoutUser = ({ children }) => {
    ...
    let data = [
        ...
        {
            nodeId: '02', nodeText: 'Project Management', iconCss: 'icon-thumbs-up-alt icon',
        },
        {
            nodeId: '03', nodeText: 'Policy & Procedure', iconCss: 'icon-docs icon',
        },
        {
            nodeId: '04', nodeText: 'Jobs', iconCss: 'icon-th icon',
            // nodeChild: [
        ...
        {
            nodeId: '05', nodeText: 'Training', iconCss: 'icon-code icon',
            // nodeChild: [
            //     { nodeId: '05-01', nodeText: 'Calendar', iconCss: 'icon-circle-thin icon' },
            //     { nodeId: '05-02', nodeText: 'DatePicker', iconCss: 'icon-circle-thin icon' },
            //     { nodeId: '05-03', nodeText: 'DateTimePicker', iconCss: 'icon-circle-thin icon' },
        ...
        {
            nodeId: '06', nodeText: 'Articles', iconCss: 'icon-chrome icon'
        },
        {
            nodeId: '07', nodeText: 'Users', iconCss: 'icon-up-hand icon'
        },
        {
            nodeId: '08', nodeText: ' Fesility Planning', iconCss: 'icon-bookmark-empty icon'
        },
    ...
    let dockSize = "44px";
    let fields = { dataSource: data, id: 'nodeId', text: 'nodeText', child: 'nodeChild' ,iconCss:"iconCss"};
    function onCreate() {
    ...
    return (
        ...
        <div className="control-section">
            <div id="wrapper">
                ...
                <div className="col-lg-12 col-sm-12 col-md-12" style={{ display: "flex", flexDirection: "column" }}>
                    <div className='main-header' id='header-section' style={{ minHeight: "80px"}}>
                        <nav className=" p-4 flex justify-between items-center border-b border-gray-300">
                            <img
                                src={"http://localhost:3000/static/media/NavIcon.e65bef8dc512ce9936bf.png"}
                                alt="Icon"
                                width={210}
                                height={36.13}
                                className=""
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <img
                                    src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmR1VLcPa0aFfNClulnJQOD2GR9Nxw-3AEFvSg9ss&s"}
                                    alt="Profile"
                                    className="w-8 h-8 rounded-full"
                                />
                                <span className="text-xl cursor-pointer text-black"><b> &#8744; </b></span>
                            </div>
                        </nav>
                    </div>
                    <SidebarComponent id="sidebar-treeview" ref={Sidebar => sidebarobj = Sidebar} width={width} target={target} mediaQuery={mediaQuery} 
                    style={{ visibility: "hidden" }} className='z-50' created={onCreate} close={onClose} dockSize={dockSize} enableDock={true}>
                    ...
                    <div className="main-content" style={{ height: "100vh" }} id="main-text">
