...
const TransesophagelAndDobutamineStressTest = () => {
  const [data] = useState([
    {
      "No. of Patients per year": 3510,
      "Propotion of T & D stress test": "2%",
      "Average Revenue per Tests":25,
      "Total":1760,
    },
  ]);
...
export default TransesophagelAndDobutamineStressTest;
