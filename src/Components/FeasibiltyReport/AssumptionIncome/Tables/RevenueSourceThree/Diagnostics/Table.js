...
const Diagnostics = () => {
  const [data] = useState([
    {
      "Test - blood and other body fluids (including urine)": 10,
      "Charge per Test": 253890,
      "No. of Tests   (Avg. Lab tests per OPD + Surgery + Admissions)": 2538900,
      "Total revenue from Pathology & Phlebetomy Lab":1777230,
      "Total budget for Outsourced Lab Services Provider":761670,
      "Total revenue":70200,
    },
  ]);
