...
const RevenueSourceTen = () => {
  const [data] = useState([
    {
      "Maximum footfall in the HIV Center per Day (30 SQM)":30,
      "Maximum footfall in the HIV Center per Annum": 9360,
      "% Achivement": "50%",
      "Average number of patients visiting the HIV Center":4680,
      "Average revenue per visit": 10,
      "Income from Source No. 10": "46800",
...
export default RevenueSourceTen;
