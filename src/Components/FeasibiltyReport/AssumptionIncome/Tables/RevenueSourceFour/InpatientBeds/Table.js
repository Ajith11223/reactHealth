...
const InpatientsBed = () => {
  const [data] = useState([
    {
      "Number of Beds": 100,
      "Total Bed Days Available": 31200,
      "Maximum annual in-patients that can be accomodated": 8914,
      "Achievement%":"30%",
      "Inpatients serviced per year":2675,
      "No. of patients per year contributing to in-patient occupancy":47580,
      "Inpatients as a % of related OPD footfall":"6%",
    },
  ]);
