...
const GeneralInpatientBeds = () => {
  const [data] = useState([
    {
      "b)General Inpatient Beds":"50",
      "No. of Patients per day": 1338,
      "Fees per bed per day": 200,
      "Consultation charge per day per patient - for the attending doctor & caring nurse": 21,
      "Revenue from 5(b): General Inpatients":1034943,
    },
  ]);
...
export default GeneralInpatientBeds;
