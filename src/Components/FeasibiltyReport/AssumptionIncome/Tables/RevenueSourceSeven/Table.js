...
const RevenueSourceSeven = () => {
  const [data] = useState([
    {
      "Two cafeteria of 75 SQM each":150,
      "Average Revenue per Revenue Driver (Rent per Sq Mt)": 20,
      "Income from Source No. 7": 36000,
    },
  ]);
...
export default RevenueSourceSeven;
