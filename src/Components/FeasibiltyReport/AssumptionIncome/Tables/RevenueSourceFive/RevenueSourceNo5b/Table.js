...
const RevenueSourceNo5b = () => {
  const [data] = useState([
    {
      "No. of therapists(on call)":"",
      "No. of therapies per day": "",
      "Level of occupancy": "",
      "Total No. of Therapies": "",
      "Average Fee per Therapy (Including home therapies)":"",
      "Income from Source No.5(b)":"",
    },
  ]);
...
export default RevenueSourceNo5b;
