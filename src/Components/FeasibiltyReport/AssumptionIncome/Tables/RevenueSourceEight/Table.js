...
const RevenueSourceEight = () => {
  const [data] = useState([
    {
      "Number of Operation Theatre Rooms (OR)":"",
      "Max. Operations per OR per Day": "",
      "Max. Operations Per Annum in the hospital": "",
      "%Achievement":"",
      "Average number of OR procedures per annum":"",
      "Average revenue per OR procedure":"",
      "Income from Source No. 8":"",
    },
  ]);
...
export default RevenueSourceEight;
